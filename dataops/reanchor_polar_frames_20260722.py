#!/usr/bin/env python3
"""Fix the polar/paired/lagging KT marks that sit on the wrong frame (user report, 2026-07-22:
...
ROOT = "/Volumes/4 MB"
CUR = f"{ROOT}/annotations/kt_points.csv"
BAK = f"{ROOT}/_master_backups/kt_points_pre_kt_tsec_repair_20260722.csv"
...
if APPLY and restored:
    ...
    b = f"{ROOT}/_master_backups/kt_points_pre_polar_reanchor_{ts}.csv"
    shutil.copy(CUR, b)
    tmp = CUR + ".tmp"
