...
WHERE IT CAME FROM (traced, not guessed):
  ...
  * BOTH CSVs are copied to `/Volumes/4 MB/4_TABLES_AND_REPORTS/2_TABLES_AND_REPORTS/frap_bps_poster_data_20260817/` with a README, because the
...
ARCH = "/Volumes/4 MB/4_TABLES_AND_REPORTS/2_TABLES_AND_REPORTS/frap_bps_poster_data_20260817"
