...
"""Dedicated 1:1:1 builder for ONE figure:
   G5_mad1_timestrip_20260303_Mad1_Ptk_Eyfpmad1_ablation_10  (Mad1-series ablation timestrip).
...
CHANNEL LABEL: this is the *Eyfpmad1* line (eYFP fused to Mad1) -> fluor channel = "eYFP-Mad1", matching the
488=Mad1 assignment for the Mad1 marker line (reference_mad1_if_channel_markers). This is the one Mad1-series
example where the builder's hardcoded "eYFP-Mad1" label is actually correct; kept as-is here.
...
ID = "G5_mad1_timestrip_20260303_Mad1_Ptk_Eyfpmad1_ablation_10"
DATA_CSV = f"/Volumes/4 MB/ablation_plots/data/{ID}.csv"
FLUOR_LABEL = "eYFP-Mad1"    # <-- Eyfpmad1 line; builder default is correct for this cell
