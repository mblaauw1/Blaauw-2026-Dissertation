...
#!/usr/bin/env python3
"""Standalone 1:1:1 builder for ONE figure: G4_polar_timestrip_20260416_single_ablation_10.

Polar-chromosome / sisterless-outcome TIMESTRIP (kind=plate_whole): FLUOR-only ablation strip
...
"20260416 single ablation_10" and emitting ONLY the non-aligned main output (the FIGURE_INDEX target).
