...
The ALIGNED-CROP variant of the low-dose-nocodazole drug-control ablation timestrip for batch
"20260416 ptk2 eyfp cdc20 ablation plus low dose noc_15" (1 ablation; cell had NOT reached anaphase
by 1:18:00 — mitotic arrest).
...
STEM  = "G9_drug_timestrip_noc"
BATCH = "20260416 ptk2 eyfp cdc20 ablation plus low dose noc_15"
ID    = f"{STEM}_aligned"
