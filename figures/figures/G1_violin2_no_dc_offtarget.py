#!/usr/bin/env python3
"""Standalone 1:1:1 builder for G1_violin2_no_dc_offtarget.
Violin 2 — sisterless groups + matched off-target only.
Rebuilds ONLY this figure from data/G1_violin2_no_dc_offtarget.csv
...
"3-Sister Controls"] order, show_uncaptured=False (non-journal original).
...
ORDER = ["unModified", "1-Sister", "1-Sister Controls", "2-Sister", "2-Sister Controls",
         "3-Sister", "3-Sister Controls"]
TITLE = "Violin 2 — sisterless groups + matched off-target only"
WIDTH = 10
