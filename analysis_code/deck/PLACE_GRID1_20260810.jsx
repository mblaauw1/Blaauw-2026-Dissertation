...
var PDF="/Volumes/4 MB/ablation_figures_20260625/_ai_relink/pdf/G6_amplitude_by_definition_panels.pdf";
...
if(!f.exists){ log.push("PDF MISSING"); doc.close(SaveOptions.DONOTSAVECHANGES); }
  ...
  var y=-6700;
  it.position=[3800, y];
  var t=doc.textFrames.add(); t.contents="G6_amplitude_by_definition_panels";
...
var lf=new File("/Volumes/4 MB/_claude_tmp/place_grid1_report.txt"); lf.open("w"); lf.write(log.join("\n")); lf.close();
log.join("\n");
