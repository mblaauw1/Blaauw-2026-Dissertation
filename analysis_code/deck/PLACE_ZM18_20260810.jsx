...
var PDF="/Volumes/4 MB/ablation_figures_20260625/_ai_relink/pdf/G9_drug_timestrip_zm18_aligned.pdf";
...
if(!f.exists){ log.push("PDF MISSING"); doc.close(SaveOptions.DONOTSAVECHANGES); }
  ...
  var y=minY-140;
  it.position=[minX,y];
  var t=doc.textFrames.add(); t.contents="G9_drug_timestrip_zm18_aligned";
  t.textRange.characterAttributes.size=13; t.position=[minX,y+22];
...
var lf=new File("/Volumes/4 MB/_claude_tmp/place_zm18_report.txt"); lf.open("w"); lf.write(log.join("\n")); lf.close();
log.join("\n");
