...
var PDF="/Volumes/4 MB/ablation_figures_20260625/_ai_relink/pdf/G6_osc_metric_sensitivity_threegroup.pdf";
...
if(!f.exists){ log.push("PDF MISSING"); doc.close(SaveOptions.DONOTSAVECHANGES); }
  ...
  var y=-6760;
  it.position=[2400, y];
  var t=doc.textFrames.add(); t.contents="G6_osc_metric_sensitivity_threegroup";
  t.textRange.characterAttributes.size=13; t.position=[2400, y+22];
...
var lf=new File("/Volumes/4 MB/_claude_tmp/place_osc_report.txt"); lf.open("w"); lf.write(log.join("\n")); lf.close();
log.join("\n");
