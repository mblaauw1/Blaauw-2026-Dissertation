...
doc.artboards.setActiveArtboardIndex(4);          // 0-based -> artboard 5
var ef=new ExportOptionsPNG24();
ef.artBoardClipping=true; ef.horizontalScale=12; ef.verticalScale=12;
doc.exportFile(new File("/Volumes/4 MB/_claude_tmp/ab5_board.png"), ExportType.PNG24, ef);
beat("exported ab5_board.png");
