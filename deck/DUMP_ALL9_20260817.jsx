// READ-ONLY geometry dump of ALL NINE decks (the six live ones, the two publication copies, the repeats deck): artboards + items, with artboard assignment by OVERLAP
...
var DECKS = [
  ...
  ["repeats", "/Volumes/4 MB/1_DECKS/repeated figures 081726.ai"]
];

var HB = new File("/Volumes/4 MB/_claude_tmp/dump_all9_heartbeat.txt");
...
for (var d = 0; d < DECKS.length; d++) {
  ...
  var f = new File("/Volumes/4 MB/_claude_tmp/geom9_" + tag + ".tsv");
  f.encoding = "UTF-8";
  f.open("w");
