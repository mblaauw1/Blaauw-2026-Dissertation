...
var NAME="G9_drug_timestrip_zm18_aligned";
var log=[];
...
if(!item){ log.push("strip NOT FOUND; not saving"); doc.close(SaveOptions.DONOTSAVECHANGES); }
  ...
  var NX=2400, NY=-5970;                     // right of the band, inside the canvas
...
var lf=new File("/Volumes/4 MB/_claude_tmp/move_zm18_report.txt"); lf.open("w"); lf.write(log.join("\n")); lf.close();
log.join("\n");
