...
var HB  = new File(TMP + "/deoverlap9_heartbeat.txt");
...
beat("START");
var plan = eval("(" + readAll(TMP + "/deoverlap_moves9_20260817.json") + ")");
var report = [];
var i;
...
var rf = new File(TMP + "/deoverlap_report9.txt"); rf.encoding = "UTF-8"; rf.open("w");
